...
f = open('/Users/devashishthakur/Documents/Machine Learning/ML-Project/ML-Code/Adaboost/results-MNB-5.txt','a')
import time
y = Y
for i in range(1,1000):
    ...
    start = time.clock()
    print(skf)  
    clf = AdaBoostClassifier(MultinomialNB(alpha=1),n_estimators=i)
    # clf = AdaBoostClassifier(DecisionTreeClassifier(max_depth=25),n_estimators=i)
