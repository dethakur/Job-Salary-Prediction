...
rf = open('/Users/devashishthakur/Documents/Machine Learning/Job-Salary-Prediction/Job-Salary-Prediction/info-files/company-distribution.txt','r')
...
plt.title("Company Names Frequency across clusters")
